    ...
    <div className="space-y-20 md:space-y-32 pb-24 md:pb-32 px-4 sm:px-6 md:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-primary/5 px-5 py-2 rounded-full border border-primary/10">
              ...
              <span className="text-xs font-black uppercase tracking-[0.2em] text-primary">Nền tảng tái chế thế hệ mới</span>
            </div>
            ...
            <div className="relative aspect-[4/3] rounded-[2rem] sm:rounded-[3rem] overflow-hidden botanical-shadow">
              ...
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-8 eco-glass p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-white/20">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-primary">Tác động toàn cầu</p>
                    <p className="text-lg font-serif italic text-on-surface">Giảm 15% rác thải nhựa đô thị</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="space-y-24">
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-serif italic leading-tight">Hệ lụy của <br /> <span className="not-italic text-error">Sự thờ ơ</span></h2>
          <p className="text-xl text-on-surface-variant font-light leading-relaxed">
            Rác thải không tự nhiên biến mất. Mỗi mảnh nhựa vứt bỏ sai chỗ là một "vết sẹo" để lại trên cơ thể của Trái Đất.
          </p>
        </div>
      ...
      <section className="space-y-24">
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-serif italic leading-tight">Quy trình <br /> <span className="not-italic text-primary">Vận hành</span></h2>
          <p className="text-xl text-on-surface-variant font-light leading-relaxed">
            Chúng tôi kết hợp công nghệ AI tiên tiến với mạng lưới hậu cần thông minh để tối ưu hóa việc tái chế.
          </p>
      ...
      <section className="bg-on-surface text-surface rounded-[2.5rem] sm:rounded-[4rem] p-8 sm:p-12 md:p-24 overflow-hidden relative">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            <h2 className="text-4xl sm:text-5xl md:text-7xl font-serif italic leading-tight">Phân loại <br /> <span className="not-italic text-primary-container">Chính xác</span></h2>
            <p className="text-xl text-surface/70 font-light leading-relaxed max-w-lg">
              Mỗi vật liệu đều có giá trị nếu được đặt đúng chỗ. Chúng tôi hỗ trợ xử lý hơn 20 loại rác thải khác nhau.
            </p>
            <div className="flex flex-wrap gap-4">
              {['Nhựa', 'Giấy', 'Kim loại', 'Điện tử', 'Thủy tinh', 'Hữu cơ'].map(cat => (
                <span key={cat} className="px-6 py-3 rounded-full border border-surface/20 text-sm font-bold hover:bg-surface hover:text-on-surface transition-all cursor-default">
                  {cat}
                </span>
              ))}
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <motion.div whileHover={{ y: -10 }} className="aspect-square rounded-3xl overflow-hidden sm:mt-12">
              <img
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div className="space-y-10">
          <div className="flex items-end justify-between">
            <h2 className="text-4xl font-serif italic">Bảng xếp hạng <span className="not-italic text-primary">Tuần</span></h2>
            <button className="text-xs font-black uppercase tracking-widest text-on-surface-variant hover:text-primary transition-colors">Tất cả</button>
          </div>
          <div className="bg-surface-container-lowest rounded-[3rem] p-8 botanical-shadow border border-surface-container-high/50 divide-y divide-surface-container-high">
            <LeaderboardItem rank={1} name="Nguyễn Văn A" points="4,250" avatar="https://picsum.photos/seed/user1/100/100" />
            <LeaderboardItem rank={2} name="Trần Thị B" points="3,800" avatar="https://picsum.photos/seed/user2/100/100" />
            <LeaderboardItem rank={3} name="Lê Văn C" points="3,150" avatar="https://picsum.photos/seed/user3/100/100" />
            <LeaderboardItem rank={4} name="Phạm Minh D" points="2,900" avatar="https://picsum.photos/seed/user4/100/100" />
          </div>
        </div>

        <div className="space-y-10">
          <div className="flex items-end justify-between">
            <h2 className="text-4xl font-serif italic">Hoạt động <span className="not-italic text-primary">Trực tiếp</span></h2>
          ...
          <div className="bg-surface-container-lowest rounded-[3rem] p-8 botanical-shadow border border-surface-container-high/50 space-y-2">
            <ActivityItem user="Minh" action="vừa phân loại 2kg nhựa" time="2 phút trước" icon={<Recycle className="w-4 h-4" />} />
            <ActivityItem user="An" action="vừa đổi quà: Túi vải canvas" time="15 phút trước" icon={<Trophy className="w-4 h-4" />} />
            <ActivityItem user="Hoàng" action="đã hoàn thành thử thách tuần" time="1 giờ trước" icon={<Check className="w-4 h-4" />} />
            <ActivityItem user="Linh" action="vừa tham gia EcoSort" time="2 giờ trước" icon={<Leaf className="w-4 h-4" />} />
          </div>
        </div>
      </div>
      ...
      <section className="relative rounded-[2.5rem] sm:rounded-[4rem] overflow-hidden min-h-[420px] sm:min-h-[520px] lg:min-h-[600px] flex items-center justify-center text-center p-6 sm:p-10 md:p-12">
        ...
        <div className="relative z-10 max-w-4xl space-y-12 text-white">
          ...
          <p className="text-base sm:text-lg md:text-2xl font-light italic opacity-90 max-w-2xl mx-auto">
            "Hành trình vạn dặm bắt đầu từ một bước chân. Hành trình xanh bắt đầu từ một hành động nhỏ."
          </p>
...
function ImpactStat({ label, value, unit }: any) {
  return (
...
function LeaderboardItem({ rank, name, points, avatar }: any) {
  return (
    <div className="flex items-center justify-between py-6 group cursor-pointer">
      <div className="flex items-center gap-6">
        <span className={`w-8 text-2xl font-serif italic ${rank <= 3 ? 'text-primary' : 'text-on-surface-variant/30'}`}>
          {rank}
        </span>
        <div className="relative">
          <img src={avatar} alt={name} className="w-14 h-14 rounded-2xl object-cover grayscale group-hover:grayscale-0 transition-all" referrerPolicy="no-referrer" />
          {rank === 1 && <div className="absolute -top-2 -right-2 bg-primary text-white p-1 rounded-lg"><Trophy className="w-3 h-3" /></div>}
        </div>
        <span className="text-xl font-serif italic text-on-surface group-hover:text-primary transition-colors">{name}</span>
      </div>
      <div className="text-right">
        <p className="text-2xl font-serif italic text-primary">{points}</p>
        <p className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant/40">Points</p>
      </div>
    </div>
  );
}

function ActivityItem({ user, action, time, icon }: any) {
  return (
    <div className="flex items-start gap-6 p-6 hover:bg-surface-container-low rounded-[2rem] transition-all cursor-pointer group">
      ...
      <div className="space-y-1">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40">{time}</p>
      </div>
    </div>
  );
}

function HarmfulEffectCard({ image, title, description }: any) {
  return (
    <motion.div 
      whileHover={{ y: -10 }}
